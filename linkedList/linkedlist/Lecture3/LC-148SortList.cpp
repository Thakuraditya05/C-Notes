...
// int main(){
//     // merge sort   
// // value ko sort nahi krna hai mujhe 
// // puri  linked list ko sort krna hai  and base case ek elemnt 
// // temp=head 
// // temp le chalo left middle pe  even sized ke liye 
// // temp = middle mark kr lo 

// // linked list ko do me tod do 
// // tutu hue liked liste ke luye same function lagao todne ka 
// // fir inn dono ko merge kr do aaccordinging to LC-21   marge function 
